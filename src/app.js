...
app.use(cookieParser()); // what this does : it parses the cookies attached to the client request object. When a client sends a request with cookies, this middleware will read the cookies and populate the req.cookies property with an object containing the cookie names and their corresponding values. This is essential for handling authentication, sessions, or any other functionality that relies on cookies.
// cors configuration
app.use(
  cors({
